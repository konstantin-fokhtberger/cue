...
| NFR-TEST-001   | TEST-NATIVE-AUDIO-001                          | CI-SWIFT-COVERAGE-001                                                                                                | Swift core is 100% covered for lines, functions, instantiations, and executable regions; executable platform boundary remains open  |
| NFR-TEST-002   | TEST-NATIVE-AUDIO-001                          | CI-SWIFT-MUTATION-001                                                                                                | 38/38 viable Swift lifecycle, format, bounds, protocol, metrics, and cleanup mutants killed locally; GitHub CI evidence pending     |
