...
| FR-PRIV-007    | AUDIO-CAPTURE-SCOPE-001                        | UT-SCOPE-RESOLVER-001, CT-SCOPE-INSTANCE-001, CT-SCOPE-STALE-001, CT-NO-GLOBAL-STT-001, MT-SCOPE-POLICY-001                                 | diagnostic-global scope cannot cross the provider boundary; the fail-closed pure application resolver is structurally and mutation verified; live CoreAudio inventory, IPC, disclosure UI, and target-Mac isolation remain open |
