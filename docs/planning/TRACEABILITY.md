...
| FR-AUDIO-008   | AUDIO-DEVICE-001              | UT-AUDIO-DEVICE-POLICY-001, CT-AUDIO-DEVICE-POLICY-001 | with macOS default Sony, explicit HyperX selection and persistence passed; live effective track and restart remain open |
| FR-AUDIO-009   | AUDIO-DEVICE-001              | CT-AUDIO-OUTPUT-POLICY-001, RT-MAC-SONY-OUT-001        | exact Sony sink was accepted, displayed effective, and persisted; audible cue-owned playback remains open               |
