...
| FR-AUDIO-008   | AUDIO-DEVICE-001, AUDIO-DIAG-001 | E2E-AUDIO-DIAG-001, RT-MAC-HYPERX-RESTART-001        | exact HyperX effective track, healthy PCM, persistence and controlled input restart passed                             |
| FR-AUDIO-009   | AUDIO-DEVICE-001, AUDIO-DIAG-001 | CT-AUDIO-DIAG-SINK-001, RT-MAC-SONY-OUT-001          | exact Sony sink, bounded tone graph and human audible confirmation passed                                              |
