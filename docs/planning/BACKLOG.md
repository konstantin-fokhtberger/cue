...
| AUDIO-CAPTURE-SCOPE-001 | EPIC-002 |       P0 | ready    | Implement verified application scope, cue exclusion, and no-global-fallback policy  | ADR-CAPTURE-SCOPE-001, TEST-NATIVE-AUDIO-001 |
...
1. `BUG-AUDIO-004` and `AUDIO-CAPTURE-SCOPE-001` - introduce one versioned stdin configuration
