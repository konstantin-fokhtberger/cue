...
| TEST-AUDIO-001 | EPIC-002 | P0 | proposed | Capture adapter contract suite and deterministic audio fixtures | TOOL-001 |
...
1. `TOOL-001` - test and quality toolchain decision.
