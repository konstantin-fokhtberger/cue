...
| CI-001            | EPIC-001 |       P0 | verifying | Add pull-request CI with reproducible dependency installation   | TOOL-001                        |
| CI-002            | EPIC-001 |       P0 | proposed  | Add self-hosted target-Mac test lane                            | CI-001                          |
| SPIKE-AUDIO-001   | EPIC-002 |       P0 | ready     | Modern Electron/CoreAudio Tap feasibility spike                 | TOOL-001                        |
