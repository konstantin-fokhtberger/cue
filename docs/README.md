...
| Quality debt | [Legacy baseline](quality/LEGACY_COVERAGE_BASELINE.md) | Bounded temporary exclusions and their removal gate              |
...
| Changes      | [TOOL-001](changes/TOOL-001.md)                        | First executable quality-toolchain change record                 |
